...
public class TopBarNode extends Pane {
    ...
    private void buildThemeMenu() {
        ...
        themeMenu.getStylesheets().add("vidmot/stylesheets/classic-styles.css");

        Menu fxTheme = new Menu();
        fxTheme.getStyleClass().add("fxtheme");
    ...
    private void buildHomeButton() {
        ...
        homeButton.setOnMouseEntered(mouseEvent -> homeButton.getStyleClass().add("fxHiglightedHomeButton"));
        homeButton.setOnMouseExited(mouseEvent -> homeButton.getStyleClass().add("fxhomeButton"));
    }
